...
const academicSupportRouter = () => {
  return [
    ...
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<AcademicInformation />} />
        </Suspense>
      ),
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<CertificatesIssuance />} />
        </Suspense>
      ),
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<FormsApplications />} />
        </Suspense>
      ),
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<Scholarships />} />
        </Suspense>
      ),
    },
    {
    ...
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<UndergraduateCurriculum />} />
        </Suspense>
      ),
    },
  ];
