...
const campusLifeRouter = () => {
  return [
    ...
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<AdministrativeOfficesInstitutes />} />
        </Suspense>
      ),
    },
    {
    ...
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<LostFoundBoard />} />
        </Suspense>
      ),
    },
    {
    ...
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<ServiceGuide />} />
        </Suspense>
      ),
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <BasicLayout children={<StudentActivities />} />
        </Suspense>
      ),
    },
  ];
